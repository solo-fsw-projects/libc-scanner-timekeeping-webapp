...
function buildMainSummarySheet(
  ...
  const totalsRow = [
    ...
    totals.activeCount,
    totals.onTimeCount,
    formatHoursFromMinutes(totals.onTimeMinutes),
    formatPercentage(totals.onTimeMinutes, totals.durationMinutes),
    totals.lateCount,
    formatHoursFromMinutes(totals.lateMinutes),
  ...
  const totalsKnownProjectsRow = [
    ...
    formatHoursFromMinutes(totalsExcludingUnknown.onTimeMinutes),
    ...
    formatHoursFromMinutes(totalsExcludingUnknown.lateMinutes),
